...
namespace Tests
{
    ...
    public class QuizController1Tests
    {
        ...
        public void GenerateQuestionsTest()
        {
            ...
            QuizController1 test = new QuizController1();
            ...
            Answer testAnswer1 = testQuestion.GetAnswer(0);
